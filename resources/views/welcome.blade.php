          ...
          <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card border hover-shadow-6 mb-6 d-block">
                      ...
                      <div class="p-6 text-center">
                        ...
                        <h5 class="mb-0"><a class="text-dark" href="#">{{$post->title}}e</a></h5>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-4 col-xl-3">
              <div class="sidebar px-4 py-md-0">
                ...
                <p class="small-3">Blog Post App Created from Udemy Kati Franz Course about Laravel</p>
    ...
    <footer class="footer">
      <div class="container">
        <div class="row gap-y align-items-center">
          ...
          <div class="col-6 col-lg-3 text-center order-lg-last">
            <div class="social">
